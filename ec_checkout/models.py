...
class EC_Order(models.Model):
    ...
    def update_total(self):
        ...
        """
        self.ec_order_total = self.lineitems.aggregate(Sum('lineitem_total'))['lineitem_total__sum']
...
class EC_OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(EC_Product, null=False, blank=False, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f'SKU {self.product.sku} on ec_order {self.ec_order.ec_order_number}'