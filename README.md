...
# **_Dealna.de E-Commerce V1.7_**

## Dealna.de v1.7 (Shop Smart, Live Better) - Portfolio Project 5 - Full Stack Toolkit Project.

**Dealna.de v1.7:** A Gateway to Seamless Online Shopping  
...
**You can view the live site here - [Dealna.de For E-Commerce v1.7]( https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/).**  
...
- [**_Dealna.de E-Commerce V1.7_**](#dealnade-e-commerce-v17)
  - [Dealna.de v1.7 (Shop Smart, Live Better) - Portfolio Project 5 - Full Stack Toolkit Project.](#dealnade-v17-shop-smart-live-better---portfolio-project-5---full-stack-toolkit-project)
...
- [Contents](#contents)
  ...
  - [**Site Structure**](#site-structure)
    ...
    - [Dealna.de v1.7 Site Structure](#dealnade-v17-site-structure)
  ...
  - [Deployment](#deployment)
    - [🔹 Step 1: Create a Heroku App](#-step-1-create-a-heroku-app)
    - [🔹 Step 2: Add Environment Variables](#-step-2-add-environment-variables)
    - [🔹 Step 3: AWS S3 Bucket Configuration](#-step-3-aws-s3-bucket-configuration)
    - [🔹 Step 4: Prepare Project for Deployment](#-step-4-prepare-project-for-deployment)
...
- [Dealna (Live site)](#dealna-live-site)
  - [UX](#ux)
    - [The 5 Planes of UX](#the-5-planes-of-ux)
      ...
      - [1.2 Marketing Strategy](#12-marketing-strategy)
      - [1.3 UX Diagram – Business Model Canvas](#13-ux-diagram--business-model-canvas)
      - [2. Scope](#2-scope)
    ...
    - [**Neutral \& Supporting Shades**](#neutral--supporting-shades)
  ...
  - [Features](#features-1)
    ...
    - [Products (Admin Only)](#products-admin-only)
  ...
  - [SEO \& Marketing](#seo--marketing)
    - [Keywords](#keywords)
    - [**Short-Tail Keywords (Head Terms)**](#short-tail-keywords-head-terms)
    - [**Long-Tail Keywords**](#long-tail-keywords)
    - [**Example Product Keyword Mapping**](#example-product-keyword-mapping)
    - [Sitemap](#sitemap)
    - [Robots](#robots)
  ...
  - [Deployment](#deployment-1)
    ...
    - [1. **Create a New Heroku App**](#1-create-a-new-heroku-app)
  ...
  - [🖼️ Using Cloudinary to Store Media Files](#️-using-cloudinary-to-store-media-files)
    ...
    - [WhiteNoise Static File Handling](#whitenoise-static-file-handling)
    - [Local Development](#local-development)
      - [Cloning](#cloning)
      - [Forking](#forking)
    - [Local VS Deployment](#local-vs-deployment)
  - [Credits](#credits)
    - [Project Idea \& Design](#project-idea--design)
    - [Content](#content)
    - [Media](#media)
...
The **Dealna.de For E-Commerce v1.7** is accessible at [Dealna.de For E-Commerce v1.7]( https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/), offering an intuitive layout with seamless access to all sections via the navigation bar.  
...
<details><summary><span style="font-size:1.7em; font-weight:bold;">Colour Scheme</span></summary>
...
<details><summary><span style="font-size:1.7em; font-weight:bold;">Features Details</span></summary>
...
<details><summary><span style="font-size:1.7em; font-weight:bold;">Languages</span></summary>
...
| [![badge](https://img.shields.io/badge/HTML5-grey?logo=html5&logoColor=E34F26)](https://developer.mozilla.org/en-US/docs/Web/HTML) | Main site structure and semantic content. |
| [![badge](https://img.shields.io/badge/CSS3-grey?logo=css3&logoColor=1572B6)](https://developer.mozilla.org/en-US/docs/Web/CSS) | Styles, layouts, and responsive design. |
| [![badge](https://img.shields.io/badge/JavaScript-grey?logo=javascript&logoColor=F7DF1E)](https://developer.mozilla.org/en-US/docs/Web/JavaScript) | Adds interactivity (navigation menus, cart, filters). |
| [![badge](https://img.shields.io/badge/Python-grey?logo=python&logoColor=3776AB)](https://www.python.org) | Backend logic, data handling, integration. |
| [![badge](https://img.shields.io/badge/Django-grey?logo=django&logoColor=092E20)](https://www.djangoproject.com) | Python framework for server-side logic and templates. |
| [![badge](https://img.shields.io/badge/Bootstrap-grey?logo=bootstrap&logoColor=7952B3)](https://getbootstrap.com) | Front-end framework for responsive design and components. |
| [![badge](https://img.shields.io/badge/Django--Allauth-grey?logo=django&logoColor=092E20)](https://django-allauth.readthedocs.io/en/latest/) | User authentication and login plugin for Django. |
| [![badge](https://img.shields.io/badge/jQuery-grey?logo=jquery&logoColor=0769AD)](https://jquery.com/) | Bootstrap component initialization and cart functionality. |
| [![badge](https://img.shields.io/badge/Heroku-grey?logo=heroku&logoColor=430098)](https://www.heroku.com) | Hosting the deployed back-end site. |
| [![badge](https://img.shields.io/badge/PostgreSQL-grey?logo=postgresql&logoColor=4169E1)](https://www.postgresql.org) | Relational database management. |
| [![badge](https://img.shields.io/badge/SQLite3-grey?logo=sqlite&logoColor=003B57)](https://www.sqlite.org) | Default development database for local testing. |
| [![badge](https://img.shields.io/badge/AWS_S3-grey?logo=amazonaws&logoColor=FF9900)](https://aws.amazon.com/s3/) | Cloud storage for static and media files. |
| [![badge](https://img.shields.io/badge/Cloudinary-grey?logo=cloudinary&logoColor=3448C5)](https://cloudinary.com) | Hosting and optimizing images for faster load. |
| [![badge](https://img.shields.io/badge/WhiteNoise-grey?logo=python&logoColor=FFFFFF)](https://whitenoise.readthedocs.io) | Serve static files in production with Heroku. |
| [![badge](https://img.shields.io/badge/Stripe-grey?logo=stripe&logoColor=008CDD)](https://stripe.com) | Secure online payment integration. |
| [![badge](https://img.shields.io/badge/Gmail_API-grey?logo=gmail&logoColor=EA4335)](https://mail.google.com) | Sending transactional emails from the application. |
| [![badge](https://img.shields.io/badge/Font_Awesome-grey?logo=fontawesome&logoColor=528DD7)](https://fontawesome.com) | Icons for UI elements and headings. |
| [![badge](https://img.shields.io/badge/Google_Fonts-grey?logo=google&logoColor=4285F4)](https://fonts.google.com/) | Web fonts for modern typography. |
| [![badge](https://img.shields.io/badge/Favicon_Generator-grey?logo=html5&logoColor=000000)](https://favicon.io/) | Generate professional favicons for all devices. |
...
Tested website: [https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/](https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/)
...
To set up **Dealna.de v1.7** locally for development or testing purposes, follow these steps:
...
The **live Dealna.de v1.7** app is hosted on [Heroku](https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/).
Static files are served via **WhiteNoise** (locally) and **AWS S3** (production) for media assets.
...
3. Enter a **unique app name** and select **Europe (EU)** region.
4. Click **Create App**.
...
Add these **Config Vars** in Heroku → **Settings → Reveal Config Vars**:
...
os.environ.setdefault("AWS_STORAGE_BUCKET_NAME", "dealna-de-v1-3-bucket")
...
### 🔹 Step 3: AWS S3 Bucket Configuration
...
This ensures **media files** (product images, user uploads) are stored and served from AWS S3, while **static files** can also be served via custom storage or WhiteNoise.

---

### 🔹 Step 4: Prepare Project for Deployment

1. Ensure **`requirements.txt`** and **`Procfile`** exist in the project root.
2. Specify Python version in **`.python-version`**:
...
4. Add **WhiteNoise** middleware in `settings.py` for static files:
...
* Link Heroku to your GitHub repository.
* Enable **Automatic Deploys** from the `main` branch.
* Click **Deploy Branch** for initial deployment.
...
### 🔹 Step 6: Stripe Payments & Webhooks

* Add **Stripe API keys** to `env.py` and Heroku.
* Set up **Stripe Webhooks** for order confirmations.
* Keys stored securely in environment variables.

---

### 🔹 Step 7: Gmail Notifications

* Enable **App Passwords** for Gmail.
* Add credentials to `env.py` and Heroku to send automated emails (order confirmations, receipts).

---

### 🔹 Step 8: Access the App

* GitHub Repository: [Dealna.de v1.4](https://github.com/MohamedMesto/Dealna.de_v1.4)
* Live Site: [Dealna.de v1.7](https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/)
...
* Media files: served via **AWS S3**
* Stripe handles all secure online payments
* Gmail API handles automatic emails
...
You can view the live site here also: [Dealna.de For E-Commerce v1.7]( https://dealna-de-v1-7-48a0c9a14b06.herokuapp.com/).
